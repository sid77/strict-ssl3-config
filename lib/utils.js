...
function storeAllPreferences() {
  ...
  preferences = keys.concat(prefs.keys("security.ssl.require_safe_negotiation"));
  initPreferences = keys.concat(prefs.keys("security.ssl.treat_unsafe_negotiation_as_broken"));
}
